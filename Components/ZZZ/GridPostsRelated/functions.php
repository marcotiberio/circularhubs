...
namespace Flynt\Components\GridPostsRelated;
...
add_filter('Flynt/addComponentData?name=GridPostsRelated', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'GridPostsRelated',
        'label' => 'Grid: Related Posts',
        'sub_fields' => [
            [
                'label' => __('Info', 'flynt'),
                'name' => 'infoTab',
...
Options::addTranslatable('GridPostsRelated', [
    [
