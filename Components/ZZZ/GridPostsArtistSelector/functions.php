...
namespace Flynt\Components\GridPostsArtistSelector;
...
add_filter('Flynt/addComponentData?name=GridPostsArtistSelector', function ($data) {
...
{
    return [
        'name' => 'GridPostsArtistSelector',
        'label' => 'Grid: Posts Artist Selector',
        'sub_fields' => [
            [
