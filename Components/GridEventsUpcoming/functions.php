...
namespace Flynt\Components\GridEventsUpcoming;
...
add_filter('Flynt/addComponentData?name=GridEventsUpcoming', function ($data) {
    $postType = POST_TYPE;
...
Options::addTranslatable('GridEventsUpcoming', [
    [
